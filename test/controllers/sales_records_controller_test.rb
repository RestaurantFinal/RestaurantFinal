...
class SalesRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sales_record" do
    assert_difference("SalesRecord.count") do
      post sales_records_url, params: { sales_record: { date: @sales_record.date, price: @sales_record.price, product_id: @sales_record.product_id, product_name: @sales_record.product_name, revenue: @sales_record.revenue } }
    end
  ...
  test "should update sales_record" do
    patch sales_record_url(@sales_record), params: { sales_record: { date: @sales_record.date, price: @sales_record.price, product_id: @sales_record.product_id, product_name: @sales_record.product_name, revenue: @sales_record.revenue } }
